	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h3 class="modal-title">가입 구분 추가</h3>
			</div>
			<div class="modal-body">
				...
				<div class="input-group">
					<table>
						<tr>
							<td class="table_z"><span class="code_c">No</span> <input type="text"
								id="code_a"></td>
							<td class="table_z"><span class="code_c">가입 구분</span> <input type="text"
								id="code_a"></td>
							<td class="table_z"><span class="code_c">코드 번호</span> <input type="text"
								id="code_a"></td>
						</tr>
					</table>
				</div>
